...
var starfields = document.getElementsByClassName("starfield");
starfields.style.webkitTransform = "rotate("+ tiltLR +"deg) rotate3d(1,0,0, "+ (tiltFB*-1)+"deg)";
starfields.style.MozTransform = "rotate("+ tiltLR +"deg)";
starfields.style.transform =
